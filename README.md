...
![Tech Wizardry & Linguistic Alchemy]([https://rapter.pages.dev/img/icons/html.svg](https://skillicons.dev/icons?i=html,css,js,php,python,flask,vscode,linux,cloudflare,docker,github,git,nginx,wndows))
